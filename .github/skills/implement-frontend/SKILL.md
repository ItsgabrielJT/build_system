...
4. Para hacer el diseño UI/UX, ejecutar STICH MCP para generar un diseño basado en la spec y el contexto del proyecto. El resultado se debe usar para crear el codigo.

## Orden de implementación
```
stich design → services → hooks/state → components → pages/views → registrar ruta
```
...
- Estilos: usar ÚNICAMENTE el sistema de estilos aprobado en el proyecto (ver contexto) basado en STICH MCP
